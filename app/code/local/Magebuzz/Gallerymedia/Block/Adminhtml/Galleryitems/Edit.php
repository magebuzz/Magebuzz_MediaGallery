...
class Magebuzz_Gallerymedia_Block_Adminhtml_Galleryitems_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
  public function __construct()
  {
    ...
    $this->_updateButton('delete', 'label', Mage::helper('gallerymedia')->__('Delete Item'));
